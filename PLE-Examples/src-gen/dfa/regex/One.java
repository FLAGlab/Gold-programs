// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/dfa/regex/One.gold"
package dfa.regex;
import dfa.regex.*;
...
public final class One {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      ...
      $line=9;
      Object A=$fix($invokeConstructor(GDeterministicAutomaton.class,new Object[]{Q,\u03A3,qI,F,new GMethod(One.class,"\u03B4")}));
      $line=10;
      GAutomataFrame.show($cast(gold.structures.automaton.IAutomaton.class,A));
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,One.class,"main",$line);
    }
  }
  public static Object \u03B4(Object q, Object \u03C3) {
    ...
    $try:try {
      ...
      $rethrow($throwable,One.class,"\u03B4",$line);
    }
    return $result;
  }
}
